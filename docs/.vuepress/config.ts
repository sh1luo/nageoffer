...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'jk', // 必需
      link: 'https://github.com/sh1luo', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'jk | <a href="https://github.com/sh1luo/nageoffer/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
